...
// const l4__1_thriller = ["assets/images/slides/l4__slide-1/thriller-screenshot-4__1_1.png", "url(assets/images/slides/l4__slide-1/thriller-screenshot-4__1_2.png)"]

// const l4__1_lnfsg = ["assets/images/slides/l4__slide-1/lnfsg-screenshot-4__1_1.png"]

// const l5__1_thriller = ["assets/images/slides/l5__slide-1/thriller-screenshot-5__1_1.png"]

// const l5__1_lnfsg = ["assets/images/slides/l5__slide-1/lnfsg-screenshot-5__1_1.png"]

// const l5__2_thriller = ["assets/images/slides/l5__slide-2/thriller-screenshot-5__2_1.png","assets/images/slides/l5__slide-2/thriller-screenshot-5__2_2.png", "assets/images/slides/l5__slide-2/thriller-screenshot-5__2_3.png"]
...
const fill_photo_array_thr = (number_of_photos, photos_array, gallery_number, slide_number) => {
    let photo_number = 1
    while (number_of_photos > 0) {
        photos_array.push(`assets/images/slides/l${gallery_number}__slide-${slide_number}/thriller-screenshot-${gallery_number}__${slide_number}_${photo_number}.png`)
        number_of_photos--
        photo_number++
    }
...
const fill_photo_array_lnfsg = (number_of_photos, photos_array, gallery_number, slide_number) => {
    let photo_number = 1
    while (number_of_photos > 0) {
        photos_array.push(`assets/images/slides/l${gallery_number}__slide-${slide_number}/lnfsg-screenshot-${gallery_number}__${slide_number}_${photo_number}.png`)
        number_of_photos--
        photo_number++
    }
...
l4__1_thriller = fill_photo_array_thr(l4__1_thr_photos, l4__1_thriller, "4", "1")
l4__1_lnfsg = fill_photo_array_lnfsg(l4__1_lnfsg_photos, l4__1_lnfsg, "4", "1")

l5__1_thriller = fill_photo_array_thr(l5__1_thr_photos, l5__1_thriller, "5", "1")
l5__1_lnfsg = fill_photo_array_lnfsg(l5__1_lnfsg_photos, l5__1_lnfsg, "5", "1")

l5__2_thriller = fill_photo_array_thr(l5__2_thr_photos, l5__2_thriller, "5", "2")
l5__2_lnfsg = fill_photo_array_lnfsg(l5__2_lnfsg_photos, l5__2_lnfsg, "5", "2")

l5__3_thriller = fill_photo_array_thr(l5__3_thr_photos, l5__3_thriller, "5", "3")
l5__3_lnfsg = fill_photo_array_lnfsg(l5__3_lnfsg_photos, l5__3_lnfsg, "5", "3")

l6__1_thriller = fill_photo_array_thr(l6__1_thr_photos, l6__1_thriller, "6", "1")
l6__1_lnfsg = fill_photo_array_lnfsg(l6__1_lnfsg_photos, l6__1_lnfsg, "6", "1")

const l4__1_thriller_section = document.querySelector(".l4__1_thriller-section")
const l4__1_lnfsg_section = document.querySelector(".l4__1_lnfsg-section")

const l5__1_thriller_section = document.querySelector(".l5__1_thriller-section")
const l5__1_lnfsg_section = document.querySelector(".l5__1_lnfsg-section")

const l5__2_thriller_section = document.querySelector(".l5__2_thriller-section")
const l5__2_lnfsg_section = document.querySelector(".l5__2_lnfsg-section")

const l5__3_thriller_section = document.querySelector(".l5__3_thriller-section")
const l5__3_lnfsg_section = document.querySelector(".l5__3_lnfsg-section")

const l6__1_thriller_section = document.querySelector(".l6__1_thriller-section")
...
const add_photos = (gallery_no__mv, photos_array, first_slide) => {
    photos_array.forEach(photo_url => {
        ...
        new_photo.classList.add(photos_array[0].includes("thriller") ? "photo-container-thr__small" : "photo-container")
...
l5__1_finished_edit.addEventListener("click", (e) => {
    l5__1_first_slide.style.backgroundImage = "url(assets/images/gl-images-5__1.png)"
})

l5__2_finished_edit.addEventListener("click", (e) => {
    l5__2_first_slide.style.backgroundImage = "url(assets/images/gl-images-5__2.png)"
})

l5__3_finished_edit.addEventListener("click", (e) => {
    l5__3_first_slide.style.backgroundImage = "url(assets/images/gl-images-5__3.png)"
})
...
// const edited_photos_section = document.querySelector(".edited-photos-section")
